...
public class BitanAggregator extends Aggregator {

  private static final String URL_BITAN =
      "http://www.ybitan.co.il/pirce_update";
  ...
  protected void aggregatePricesAndPromos() {
    ...
    try {
      HtmlPage page = webClient.getPage(URL_BITAN);
